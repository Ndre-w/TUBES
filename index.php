  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <div class="header-actions">
        ...
        <a href="loginreg/loginreg.php" class="btn user-btn" aria-label="Profile">
          ...
          <ul class="featured-car-list">
            ...
            <li>
              <div class="featured-car-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/camera1.jpg" alt="Sony Alpha A1" loading="lazy" width="440" height="300"
                    class="w-100">
                </figure>
                ...
                <div class="card-content">
                  ...
                  <div class="card-price-wrapper">
                    ...
                    <button class="btn" onclick= "goToLogin()">Rent now</button>
            ...
            <li>
              <div class="featured-car-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/camera2.jpg" alt="Sony Alpha 7 II" loading="lazy" width="440" height="300"
                    class="w-100">
                </figure>
                ...
                <div class="card-content">
                  ...
                  <div class="card-title-wrapper">
                    <h3 class="h3 card-title">
                      <a href="#">Sony Alpha 7 II</a>
                    </h3>

                    <data class="year" value="2014">2014</data>
                  </div>
            ...
            <li>
              <div class="featured-car-card">
                ...
                <figure class="card-banner">
                  <img src="./assets/images/camera3.jpg" alt="Sony A7 Mark IV" loading="lazy" width="440"
